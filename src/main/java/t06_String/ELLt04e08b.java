...
public class ELLt04e08b {
 ...
 public static void main(String[] args) {
        ...
        if(posicion<0||posicion>=cadena.length()){
            System.out.println("Error: entrada de datos invalidos!");
        }else {
            cadenaModificada.append(cadena.substring(0, posicion) + letra + cadena.substring(posicion + 1));
