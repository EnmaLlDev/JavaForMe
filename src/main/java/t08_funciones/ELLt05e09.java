...
public class ELLt05e09 {
    ...
    quedar el saldo por debajo de cero. ¿Hay algún error? ¿Cuánto vale la variable saldo al finalizar 
    ...
    public class Ejercicio {
        ...
        public static void main(String[] args) {
            ...
            retirar(10);
            if (retirar(10) == false) {
                System.out.println("SNo se puede retirar tanto");
            }
